...
IF ( NOT CRIMILD_APP_ASSETS_DIRECTORY )
   IF ( EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/assets )
   	  SET ( CRIMILD_APP_ASSETS_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/assets )
   ENDIF ()
ENDIF ()
...
IF ( ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten" )
    IF ( NOT CRIMILD_APP_INDEX_FILE )
   	  IF ( EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${CRIMILD_APP_SOURCE_DIRECTORY}/index.html )
   	  	 SET ( CRIMILD_APP_INDEX_FILE ${CMAKE_CURRENT_SOURCE_DIR}/${CRIMILD_APP_SOURCE_DIRECTORY}/index.html )
   	  ENDIF ()
    ENDIF ()

	MESSAGE( "Assets: ${CRIMILD_APP_ASSETS_DIRECTORY}" )
	MESSAGE( "Index: ${CRIMILD_APP_INDEX_FILE}" )
    ...
    IF ( CRIMILD_APP_ASSETS_DIRECTORY ) 
		...
		FILE ( INSTALL ${CRIMILD_APP_ASSETS_DIRECTORY} DESTINATION ${CMAKE_CURRENT_BINARY_DIR} )
	ELSE ()
	...
	IF ( CRIMILD_APP_INDEX_FILE )
       CONFIGURE_FILE( ${CRIMILD_APP_INDEX_FILE} ${CMAKE_CURRENT_BINARY_DIR} COPYONLY )
	ENDIF ()
ENDIF ()
