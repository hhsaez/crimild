...
IF ( ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten" )
    ...
    IF ( CRIMILD_APP_ASSETS_DIRECTORY ) 
	    SET_TARGET_PROPERTIES( ${CRIMILD_APP_NAME} PROPERTIES LINK_FLAGS "-s DEMANGLE_SUPPORT=1 -s ALLOW_MEMORY_GROWTH=1 -s USE_WEBGL2=1 -s FULL_ES3=1 -s --preload-file ${CRIMILD_APP_ASSETS_DIRECTORY}" )
		FILE ( INSTALL ${CMAKE_CURRENT_SOURCE_DIR}/${CRIMILD_APP_ASSETS_DIRECTORY} DESTINATION ${CMAKE_CURRENT_BINARY_DIR} )
	ELSE ()
	    SET_TARGET_PROPERTIES( ${CRIMILD_APP_NAME} PROPERTIES LINK_FLAGS "-s DEMANGLE_SUPPORT=1 -s ALLOW_MEMORY_GROWTH=1 -s USE_WEBGL2=1 -s FULL_ES3=1" )
	ENDIF ()
