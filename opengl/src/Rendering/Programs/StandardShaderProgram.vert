...
layout ( location = 1 ) CRIMILD_GLSL_ATTRIBUTE vec3 aNormal;
layout ( location = 2 ) CRIMILD_GLSL_ATTRIBUTE vec3 aTangent;
layout ( location = 4 ) CRIMILD_GLSL_ATTRIBUTE vec2 aTextureCoord;
layout ( location = 5 ) CRIMILD_GLSL_ATTRIBUTE vec4 aBoneIds;
layout ( location = 6 ) CRIMILD_GLSL_ATTRIBUTE vec4 aBoneWeights;
